...
SET DllContainingTests="%~dp0SkillTracker.Repository.Tests\bin\Debug\SkillTracker.Repository.Tests.dll"
...
"%OpenCoverExe%" ^
 ...
 -skipautoprops ^
 -register:user ^
 -output:"%~dp0GeneratedReports\RepositoryCoverageReport.xml"
 @pause
exit /b %errorlevel%

:RunReportGeneratorOutput
"%ReportGeneratorExe%" ^
 -reports:"%~dp0\GeneratedReports\RepositoryCoverageReport.xml" ^
 -targetdir:"%~dp0\GeneratedReports\RepositoryReportGenerator Output"
 @pause
exit /b %errorlevel%

:RunLaunchReport
start "report" "%~dp0\GeneratedReports\RepositoryReportGenerator Output\index.htm"
@pause
exit /b %errorlevel%