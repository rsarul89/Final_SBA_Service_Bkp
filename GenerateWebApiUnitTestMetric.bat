...
SET DllContainingTests="%~dp0SkillTracker.WebApi.Tests\bin\Debug\SkillTracker.WebApi.Tests.dll"
...
"%OpenCoverExe%" ^
 ...
 -skipautoprops ^
 -register:user ^
 -output:"%~dp0GeneratedReports\WebApiTestsCoverageReport.xml"
 @pause
exit /b %errorlevel%

:RunReportGeneratorOutput
"%ReportGeneratorExe%" ^
 -reports:"%~dp0\GeneratedReports\WebApiTestsCoverageReport.xml" ^
 -targetdir:"%~dp0\GeneratedReports\WebApiTestsReportGenerator Output"
 @pause
exit /b %errorlevel%

:RunLaunchReport
start "report" "%~dp0\GeneratedReports\WebApiTestsReportGenerator Output\index.htm"
@pause
exit /b %errorlevel%